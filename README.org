...
#+CAPTION: Screenshot of magit-git-toolbelt from the Magit status menu
#+NAME: magit-git-toolbelt Magit status screenshot
...
#+CAPTION: Screenshot of magit-git-toolbelt cleanup submenu
