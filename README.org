...
Then you can access ~magit-git-toolbelt~ from the Magit status menu by typing ~\~ or ~m-x magit-git-toolbelt~.

If you don't like the ~\~ key binding to invoke ~magit-git-toolbelt~, you can set any custom value you want like so:
...
[[https://raw.githubusercontent.com/jonathanchu/magit-git-toolbelt/refs/heads/main/screenshots/20260101_magit_git_toolbelt_screenshot.png]]
